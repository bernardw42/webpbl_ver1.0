        ...
        <div className="w-screen relative">
            ...
            <div className="bg-white w-full pb-[200px] pt-[200px] max-lg:pb-[150px] flex justify-center items-center">
                <div className="max-w-7xl flex flex-col justify-center items-center gap-y-[150px] px-8">
                    <h1 className={`text-[25px] text-black text-center font-medium py-4 transition-opacity duration-1000 ${showText ? 'opacity-100' : 'opacity-0'}`} ref={textRef}>With more than 200,000 SQM warehouse and more than 500 unit vehicles with 7 variants, we don't just handle logistics. PBL also help you succeed by combining technology with operational excellence.</h1>
